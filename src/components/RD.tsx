...
export default function RD() {
  return (
    <section id="rd" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Decorative bottom */}
        <div className="mt-16 rounded-2xl bg-gradient-to-r from-blue-600 to-cyan-500 p-px">
          <div className="rounded-2xl bg-white px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
